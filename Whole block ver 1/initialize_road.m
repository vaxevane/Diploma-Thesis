...
hor2_par_slots(1,3:first_park+1) = -1;
hor2_par_slots(1,intersection(2)+3:last_park+3) = -1;
hor2_par_slots(2,3:first_park+1) = -1;
hor2_par_slots(2,intersection(2)+3:last_park+3) = -1;
...
vert2_par_slots(1,intersection(1)+4:last_park+3) = -1;
vert2_par_slots(2,3:first_park+1) = -1;
vert2_par_slots(2,intersection(1)+4:last_park+3) = -1;
