...
full_road(:,:) = -1;
[full_road,hor_lane,hor2_lane,vert_lane,vert2_lane,hor_Car_ID,hor2_Car_ID,vert_Car_ID,vert2_Car_ID,ID_max,hor_steps_parked,hor2_steps_parked,vert_steps_parked,vert2_steps_parked,hor_park_signals,hor2_park_signals,vert_park_signals,vert2_park_signals,hor_park_flags,hor2_park_flags,vert_park_flags,vert2_park_flags] = initialize_road(full_road,cars1,cars2,cars3,cars4,intersection,intersection2,intersection3,intersection4,first_park,last_park,top_is_red);
for e=2:1:20
    %Moving
    for roads=1:4
        if (roads == 1)
            [hor_lane,hor_Car_ID,ID_max,hor_park_signals,hor_park_flags,hor_change_signals] = move(hor_lane,hor_Car_ID,ID_max,new_car_prob,new_truck_prob,hor_park_signals,hor_park_flags,dec_prob,park_prob);
        elseif (roads == 2)
            [vert_lane,vert_Car_ID,ID_max,vert_park_signals,vert_park_flags,vert_change_signals] = move(vert_lane,vert_Car_ID,ID_max,new_car_prob,new_truck_prob,vert_park_signals,vert_park_flags,dec_prob,park_prob);
        elseif (roads == 3)
            [vert2_lane,vert2_Car_ID,ID_max,vert2_park_signals,vert2_park_flags,vert2_change_signals] = move(vert2_lane,vert2_Car_ID,ID_max,new_car_prob,new_truck_prob,vert2_park_signals,vert2_park_flags,dec_prob,park_prob);
        elseif (roads == 4)
            [hor2_lane,hor2_Car_ID,ID_max,hor2_park_signals,hor2_park_flags,hor2_change_signals] = move(hor2_lane,hor2_Car_ID,ID_max,new_car_prob,new_truck_prob,hor2_park_signals,hor2_park_flags,dec_prob,park_prob);
        end
    end
    ...
    for roads=1:4
        if (roads == 1)
            [hor_lane,hor_Car_ID,hor_temp,hor_park_flags,hor_steps_parked,hor_park_signals] = parking(hor_lane,hor_Car_ID,hor_park_signals,hor_change_signals,hor_park_flags,hor_steps_parked,last_park,e);
        elseif (roads == 2)
            [vert_lane,vert_Car_ID,vert_temp,vert_park_flags,vert_steps_parked,vert_park_signals] = parking(vert_lane,vert_Car_ID,vert_park_signals,vert_change_signals,vert_park_flags,vert_steps_parked,last_park,e);
        elseif (roads == 3)
            [vert2_lane,vert2_Car_ID,vert2_temp,vert2_park_flags,vert2_steps_parked,vert2_park_signals] = parking(vert2_lane,vert2_Car_ID,vert2_park_signals,vert2_change_signals,vert2_park_flags,vert2_steps_parked,last_park,e);
        elseif (roads == 4)
            [hor2_lane,hor2_Car_ID,hor2_temp,hor2_park_flags,hor2_steps_parked,hor2_park_signals] = parking(hor2_lane,hor2_Car_ID,hor2_park_signals,hor2_change_signals,hor2_park_flags,hor2_steps_parked,last_park,e);
        end
    end
    %Copying
    ...
    %Visualization
    draw(full_road,intersection,intersection2,intersection3,intersection4,top_is_red,hor_Car_ID,vert_Car_ID,hor2_Car_ID,vert2_Car_ID);
