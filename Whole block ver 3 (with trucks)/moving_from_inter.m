...
%     elseif(left_is_red && vert_lane(1,intersection(1))~=-1 && vert_lane(1,intersection(1)+1)~=-1)
%         delay_signal = -1;
%     end
...
%     elseif(top_is_red && hor_lane(1,intersection(2))~=-1 && hor_lane(1,intersection(2)+1)~=-1)
%         delay_signal = 1;
%     end   
    if(left_is_red && vert_lane(1,intersection(1))~=-1)
        delay_signal = -1;
    end
    if(top_is_red && hor_lane(1,intersection(2))~=-1)
        delay_signal = 1;
    end