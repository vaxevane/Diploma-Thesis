...
%Unique car ID
hor_Car_ID = zeros(3,c);
hor2_Car_ID = zeros(3,c);
vert_Car_ID = zeros(3,c);
vert2_Car_ID = zeros(3,c);
hor_Car_ID(1,sort(index_lane1,'descend')) = 1:cars1;
hor2_Car_ID(1,sort(index_lane4,'descend')) = 1+cars1:cars1+cars4;
vert_Car_ID(1,sort(index_lane2,'descend')) = 1+cars1+cars4:cars1+cars4+cars2;
vert2_Car_ID(1,sort(index_lane3,'descend')) = 1+cars1+cars4+cars2:cars1+cars4+cars2+cars3;
ID_max = cars1+cars4+cars2+cars3;
...
if (vert_lane(1,intersection(1))~=-1)
    ...
    vert_Car_ID(1,intersection(1)) = 0;
else
    vert_lane(1,intersection(1)) = 6;
end
if (vert2_lane(1,intersection2(1))~=-1)
    ...
    vert2_Car_ID(1,intersection2(1)) = 0;
else
    vert2_lane(1,intersection2(1)) = 6;
end
%hor2 lane 
if (vert_lane(1,intersection3(1))~=-1)
    ...
    vert_Car_ID(1,intersection3(1)) = 0;
else
    vert_lane(1,intersection3(1)) = 6;
end
if (vert2_lane(1,intersection4(1))~=-1)
    ...
    vert2_Car_ID(1,intersection4(1)) = 0;
else
    vert2_lane(1,intersection4(1)) = 6;
end